...
#define ERR0(OUTSTR) printf (OUTSTR)
#define ERR1(OUTSTR,PARM1) printf (OUTSTR,PARM1)
#define ERR2(OUTSTR,PARM1,PARM2) printf (OUTSTR,PARM1,PARM2)
#define ERR3(OUTSTR,PARM1,PARM2,PARM3) printf (OUTSTR,PARM1,PARM2,PARM3)
#define ERR4(OUTSTR,PARM1,PARM2,PARM3,PARM4) printf (OUTSTR,PARM1,PARM2,PARM3,PARM4)
...
#define ERR0(OUTSTR)
#define ERR1(OUTSTR,PARM1)
#define ERR2(OUTSTR,PARM1,PARM2)
#define ERR3(OUTSTR,PARM1,PARM2,PARAM3)
#define ERR4(OUTSTR,PARM1,PARM2,PARM3,PARM4)
...
*/
extern void nbPrintDebugLine(char* Msg, unsigned int DebugType, char *File, char *Function, int Line, unsigned int Indentation);
