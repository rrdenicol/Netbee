...
private:
	_nbExtractedFieldsDescriptorVector *FieldDescriptorsVector;
...
public:
	...
	*/
	nbeeFieldReader(_nbExtractedFieldsDescriptorVector* fieldsVct, unsigned char* dataInfo, nbNetPFLCompiler *compiler);
	...
	*/
	...
	_nbExtractedFieldsDescriptorVector* GetFields();
