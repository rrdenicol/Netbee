...
bool jit::x64::x64Backend::create_code()
{
	...
	#ifdef _DEBUG_X64_BACKEND
	{
		...
		codefilename << "cfg_x64code_" << LLcfg.getName() << ".txt";
	...
	{
		ostringstream codefilename2;
		codefilename2 << "cfg_regalloc_x64code_" << LLcfg.getName() << ".txt";
...
//#ifdef OLD_X64_OUTPUT
//	for(TraceBuilder<CFG<x64Instruction> >::trace_iterator_t t = trace_builder.begin();
//		t != trace_builder.end();
//		t++)
//	{
//		if((*t)->getCode().empty())
//			continue;
//
//		os << BBPrinter<x64Instruction, NormalPrinter<x64Instruction> >(**t);
//		//if((*t)->getId() == BasicBlock<x64Instruction>::EXIT_BB)
//		//{
